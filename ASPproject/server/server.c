/*
*this is client-server file transfer code
*author Soham Patel:110017511
*author Jaimin Patel:110017550
*/
...
// custom messages
char exitMsg[] = "quit\n";
char wellcomeMsg[] = "Welcome to File Transfer!!\n\n\nPlease try commands like\n 1. get (fileName) - to downloadFile,\n 2. put (filename) - to uploadFile or\n 3. quit - to exit\n\n";
char errorMsg[] = "enter valid command";
char foundMsg[] = "file is found!";
char notFoundMsg[] = "file not found/,, please enter another file to transfer!";
...
int main(int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        if (!fork())
        {
            printf("Client is connected with id:%d!\n", getpid());
...
int putFile(char *file, int sd)
{
    ...
    if (strcmp(message, fileFoundAction) == 0)
    {
        ...
        printf("> '%s' this file download is complete!!!\n", file);
    }
